...
const AdminLogin = () => {
  ...
  if (email.trim() === "" || password.trim() === "") {
      ...
      axios.post('adminapi/login', body, {
                      ...
                      Login in to your admin
                          ...
                          <form className="space-y-4 md:space-y-6" onSubmit={handleAdminLogin}>
                              <div>
                                  ...
                                  id="email" 
                                  required
                                  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-blue-600 block w-full p-2.5 dark:border-gray-600 dark:text-white" placeholder="name@company.com"/>
                              </div>
                              <div>
                                  ...
                                  placeholder="••••••••" 
                                  className="bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"/>
                              </div>
                              <div className="flex items-center justify-between">
                                  <div className="flex items-start">
                                      <div className="flex items-center h-5">
                                        <input id="remember" aria-describedby="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700" />
                                      </div>
                              ...
                              <button type="submit" className="w-full text-white bg-blue-900 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-3 text-center">
                                Sign in</button>
